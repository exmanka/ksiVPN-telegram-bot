...
os.environ.setdefault("TGBOT_PAYMENTS__FISCALIZATION__ENABLED", "false")
os.environ.setdefault("TGBOT_PAYMENTS__FISCALIZATION__SEND_RECEIPT", "true")
os.environ.setdefault("TGBOT_PAYMENTS__FISCALIZATION__PROVIDERS__YOOMONEY", "false")
os.environ.setdefault("TGBOT_PAYMENTS__FISCALIZATION__PROVIDERS__YOOKASSA", "false")
