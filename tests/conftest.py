...
os.environ.setdefault("TGBOT_PAYMENTS__YOOMONEY__ACCOUNT", "4100123456789")
os.environ.setdefault("TGBOT_PAYMENTS__YOOMONEY__NOTIFICATION_SECRET", "test-notification-secret")
os.environ.setdefault("TGBOT_PAYMENTS__YOOKASSA__SHOP_ID", "test-shop-id")
os.environ.setdefault("TGBOT_PAYMENTS__YOOKASSA__SECRET_KEY", "test-secret-key")
os.environ.setdefault("TGBOT_PAYMENTS__YOOKASSA__RETURN_URL", "https://t.me/ksiVPN_bot")
